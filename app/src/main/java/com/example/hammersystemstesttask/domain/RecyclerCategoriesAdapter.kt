...
class RecyclerCategoriesAdapter(private val categories: List<CategoryDomain>) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (singleItemSelectionPosition == position) {
            holder.itemView.setBackgroundColor(ContextCompat.getColor(applicationContext(), R.color.category_button_background))
            (holder.itemView as MaterialButton).setTextColor(ContextCompat.getColor(applicationContext(), R.color.button_active))
        }
        else{
            holder.itemView.setBackgroundColor(ContextCompat.getColor(applicationContext(), R.color.white))
            (holder.itemView as MaterialButton).setTextColor(ContextCompat.getColor(applicationContext(), R.color.category_button_text_passive))
        }
